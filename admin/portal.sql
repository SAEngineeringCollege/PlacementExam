...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2015 at 10:36 AM
...
--
-- Table structure for table `code_attendee`
--

CREATE TABLE IF NOT EXISTS `code_attendee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `code_attendee`
--

INSERT INTO `code_attendee` (`id`, `person1`, `person2`, `mobile`, `college`, `time_in`, `time_out`, `tot_pts`, `tot_ans`) VALUES
(10, 'Sureka', 'Soundara Pandiyan', 523543, '', '2015-07-27 08:04:14', '0000-00-00 00:00:00', 0, 5),
(11, 'Varun Raj', 'Soundara Pandiyan', 9600145622, '', '2015-07-27 08:10:34', '0000-00-00 00:00:00', 1, 5);

-- --------------------------------------------------------

--
-- Table structure for table `code_event`
--
...
--
-- Dumping data for table `code_event`
--

INSERT INTO `code_event` (`id`, `question`, `program`, `image`, `op1`, `op2`, `op3`, `op4`, `ans`, `pts`, `modify_time`, `modify_by`) VALUES
...
(42, 'dfawd', 'asd', '', 'asd', 'asd', 'asd', 'asd', '3', 10, '2015-07-27 08:24:52', 0),
(43, 'dfawdfasdd', 'asd', 'http://www.keenthemes.com/preview/metronic/theme/assets/global/plugins/jcrop/demos/demo_files/image1.jpg', 'asd', 'asd', 'asd', 'asa', '1', 10, '2015-07-27 08:26:52', 0);
...
INSERT INTO `exam_event` (`id`, `person1`, `person2`, `mobile`, `college`, `time_in`, `time_out`, `tot_pts`, `tot_ans`) VALUES
(10, 'Sureka', 'Soundara Pandiyan', 523543, '', '2015-07-27 08:04:14', '0000-00-00 00:00:00', 0, 5),
(11, 'Varun Raj', 'Soundara Pandiyan', 9600145622, '', '2015-07-27 08:10:34', '0000-00-00 00:00:00', 1, 5);
...
INSERT INTO `quiz_event` (`id`, `question`, `program`, `image`, `op1`, `op2`, `op3`, `op4`, `ans`, `pts`, `modify_time`, `modify_by`) VALUES
(37, ' Smaller page tables are implemented as a set of _______.', '', '', 'queues', 'stacks', ' counters', ' registers', '4', 10, '2014-08-11 06:37:37', 0),
(38, 'A file control block contains the information about', '', '', ' file ownership', 'file permissions', 'location of file contents', ' all of the mentioned', '4', 10, '2014-08-11 06:38:44', 0),
(39, 'Which protocol establishes the initial logical connection between a server and a client?', '', '', ' transmission control protocol', 'user datagram protocol', 'mount protocol', 'datagram congestion control protocol', '3', 10, '2014-08-11 06:39:49', 0),
(40, ' The request and release of resources are ___________.', '', '', 'command line statements', ' interrupts', 'system calls', ' special programs', '3', 10, '2014-08-11 06:41:06', 0),
